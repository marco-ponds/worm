...
function twitter() {
	...
	window.open('https://twitter.com/intent/tweet?text=' + msg + '&hashtags=javascript&via=marcoponds,top=' + winTop + ',left=' + winLeft + ',toolbar=0,status=0,width=320,height=320');
}
